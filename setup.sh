...
echo "* Installing some needed and not exactly needed software..."
apt install -y busybox-syslogd ntp ntpdate joe screen git # watchdog

echo "*Removing some unwanted software..."
